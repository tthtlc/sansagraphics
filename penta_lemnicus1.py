...
while done == False:
	...
	t=n*2*PI/360
	x_offset=a*math.sqrt(2)*math.cos(5*t)*math.cos(2*t)/(math.sin(t)*math.sin(t)+1) + 400.0
	y_offset=a*math.sqrt(2)*math.cos(5*t)*math.sin(2*t)/(math.sin(t)*math.sin(t)+1) + 240.0
