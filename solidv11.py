...
class Donut(object):
	...
	#glPolygonMode(GL_FRONT_AND_BACK, GL_LINE)
		...
		x = fA * math.sin(4*phi)*math.sin(phi) * math.cos(theta) * math.cos(3*theta)
		y = fB * math.sin(4*phi)*math.sin(phi)* math.sin(theta) * math.cos(3*theta)
		...
		nx = fA * math.sin(4*phi)*math.sin(phi)*math.sin(phi) *math.cos(theta)  * math.cos(3*theta)
		ny = fB * math.sin(4*phi)*math.sin(phi)*math.sin(phi) *math.sin(theta)  * math.cos(3*theta)
...
torus = Donut(120, 120, 3, 3, 1, batch=batch)
rx = ry = rz = 0
