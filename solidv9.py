...
class Donut(object):
	...
	#glPolygonMode(GL_FRONT_AND_BACK, GL_LINE)
		...
		x = fA * math.sin(4*phi)*math.sin(phi) * math.cos(theta)
		y = fB * math.sin(4*phi)*math.sin(phi)* math.sin(theta)
		...
		nx = fA * math.sin(4*phi)*math.sin(phi)*math.sin(phi) *math.cos(theta) 
		ny = fB * math.sin(4*phi)*math.sin(phi)*math.sin(phi) *math.sin(theta) 
