...
class Donut(object):
	...
	sstep = 2*math.pi/(uistacks-1)
	tstep = 2*math.pi/(uislices-1)
	#glPolygonMode(GL_FRONT_AND_BACK, GL_LINE)
		...
		x = fA * math.sin(t/3)* math.cos(t) * math.cos(s)
		y = fB * math.sin(t/3)* math.cos(2*t) * math.sin(s)
		z = fC * math.sin(t/3)* math.sin(t)
