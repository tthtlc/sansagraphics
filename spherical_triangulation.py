...
def draw_bilope(uistacks, uislices, radius):
	...
	#	s = -2*math.pi/2
		...
		for j in range(uistacks+1):
			s = sstep*j
			glVertex3f(radius * math.cos(vart*t) * math.cos(myvars*s), radius * math.cos(vart*t) * math.sin(myvars*s), radius * math.sin(vart*t))
			glVertex3f(radius * math.cos(vart*t+tstep) * math.cos(myvars*s), radius *math.cos(vart*t+tstep) * math.sin(myvars*s), radius * math.sin(vart*t+tstep))
		glEnd()
