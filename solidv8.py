...
class Donut(object):
	...
	#glPolygonMode(GL_FRONT_AND_BACK, GL_LINE)
		...
		x = fA * math.sin(3*phi)*math.sin(phi) * math.cos(theta)
		y = fB * math.sin(3*phi)*math.sin(phi)* math.sin(theta)
		z = fC * math.sin(3*phi)*math.cos(phi)
		...
		nx = fA * math.sin(3*phi)*math.sin(phi)*math.sin(phi) *math.cos(theta) 
		ny = fB * math.sin(3*phi)*math.sin(phi)*math.sin(phi) *math.sin(theta) 
		nz = fC * math.sin(3*phi)*math.cos(phi)*math.sin(phi) 
