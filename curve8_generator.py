### this illustrate generating two different prime numbers that are next-next prime apart.
...
while done == False:
	...
	x_offset = r*(10*math.cos(phi/a)+math.cos(phi*a))*math.cos(phi/b)+x_shift
	y_offset = r*(10*math.cos(phi/a)+math.cos(phi*a))*math.sin(phi/b)+y_shift
    ...
    counter = counter+1
    a = prime_list.prime_list[counter]
    b = prime_list.prime_list[counter+2]
